...
export default function Home(){
    ...
    return(
        ...
        <div id="top"></div>
        <section id="section-hero" aria-label="section" className="jarallax no-top no-bottom" data-video-src="https://www.youtube.com/watch?v=5qbjKpxfD64">
            <div className="overlay-bg no-top no-bottom">
                <div className="v-center">
                    <div className="container position-relative z1000">
                        <div className="spacer-double d-lg-none d-sm-block"></div>
                        <div className="spacer-double d-lg-none d-sm-block"></div>
                        <div className="spacer-double d-lg-none d-sm-block"></div>
                        <div className="row align-items-center">
                            <div className="col-lg-6 text-light pt-5">
                                <h4><span className="id-color">Fast and Easy Way to Rent a Car</span></h4>
                                <div className="spacer-10"></div>
                                <h1 className="mb-2">Explore the world with comfortable car</h1>
                                <div className="spacer-10"></div>
                                <p className="lead">Embark on unforgettable adventures and discover the world in unparalleled comfort and style with our fleet of exceptionally comfortable cars.</p>
                            </div>

                            <div className="col-lg-6">

                            </div>
                            <div className="col-lg-12 text-light" style={{backgroundSize: "100%", backgroundRepeat: "no-repeat"}}>
                                <div className="container-timeline" style={{backgroundSize: "100%", backgroundRepeat: "no-repeat"}}>
                                    <ul>
                                        <li>
                    ...
                    <div className="position-absolute d-flex bottom-20">
                        <div className="de-marquee-list d-marquee-small">
                            <div className="d-item">
                                ...
                                <span className="d-item-txt">Pickup Truck</span>
                                <span className="d-item-display">
                                <i className="d-item-dot"></i>
                              </span>
                ...
                <div className="row text-center">
                    <div className="col-md-3 col-sm-6 mb-sm-30">
                        <div className="de_count transparent text-light wow fadeInUp">
                            <h3 className="timer" data-to="{{$countCar}}" data-speed="3000">0</h3>
                            Cars
                        </div>
                    </div>
                    <div className="col-md-3 col-sm-6 mb-sm-30">
                        <div className="de_count transparent text-light wow fadeInUp">
                            <h3 className="timer" data-to="{{$countBrand}}" data-speed="3000">0</h3>
                            Brands
                        </div>
                    </div>
                    <div className="col-md-3 col-sm-6 mb-sm-30">
                        <div className="de_count transparent text-light wow fadeInUp">
                            <h3 className="timer" data-to="{{$countRental}}" data-speed="3000">0</h3>
                            Rentals
                        </div>
                    </div>
                    <div className="col-md-3 col-sm-6 mb-sm-30">
            ...
            <div className="container">
                <div className="row align-items-center">
                    ...
                    <div className="col-lg-3">
                        <div className="box-icon s2 p-small mb20 wow fadeInL fadeInRight animated" data-wow-delay=".5s">
                            <i className="fa bg-color fa-trophy"></i>
                            <div className="d-inner">
                                <h4>First className services</h4>
                                Where luxury meets exceptional care, creating unforgettable moments and exceeding your every expectation.
                            </div>
                        </div>
                        <div className="box-icon s2 p-small mb20 wow fadeInL fadeInRight     animated" data-wow-delay=".75s">
                    ...
                    <div className="col-lg-6">
                        <img src="images/misc/car-2.png" alt="" className="img-fluid wow fadeInUp"/>
                    </div>
        ...
        <section id="section-img-with-tab" className="bg-dark text-light">
                    ...
                    <div className="col-lg-5 offset-lg-7">
                        ...
                        <ul className="nav nav-pills mb-3" id="pills-tab" role="tablist">
                            <li className="nav-item" role="presentation">
                                <button className="nav-link active" id="pills-home-tab" data-bs-toggle="pill" data-bs-target="#pills-home" type="button" role="tab" aria-controls="pills-home" aria-selected="true">Luxury</button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="pills-profile-tab" data-bs-toggle="pill" data-bs-target="#pills-profile" type="button" role="tab" aria-controls="pills-profile" aria-selected="false">Comfort</button>
                            </li>
                            <li className="nav-item" role="presentation">
                                <button className="nav-link" id="pills-contact-tab" data-bs-toggle="pill" data-bs-target="#pills-contact" type="button" role="tab" aria-controls="pills-contact" aria-selected="false">Prestige</button>
                            </li>
                        </ul>
                        <div className="tab-content" id="pills-tabContent">
                            ...
                            <div className="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab"><p>We prioritize your comfort and convenience throughout your journey. We understand that a comfortable ride can make a world of difference, whether you're embarking on a business trip or enjoying a leisurely vacation. That's why we offer a wide range of well-maintained, comfortable cars that cater to your specific needs.</p></div>
                            <div className="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab"><p>We understand that prestige goes beyond luxury. It's about making a statement, embracing sophistication, and indulging in the finer things in life. That's why we offer an exclusive selection of prestigious cars that exude elegance, style, and status.</p></div>
                        </div>
            ...
            <div className="image-container col-md-6 pull-right" data-bgimage="url(images/misc/e2.jpg) center"></div>
        </section>

        <section id="section-testimonials" className="no-bottom">
                ...
                <div className="row g-0 align-items-center">
                    ...
                    <div className="col-md-4">
                        <div className="de-image-text">
                            ...
                            <img src="images/testimonial/1.jpg" className="img-fluid" alt=""/>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className="de-image-text">
                            ...
                            <img src="images/testimonial/2.jpg" className="img-fluid" alt=""/>
                        </div>
                    </div>
                    ...
                    <div className="col-md-4">
                        <div className="de-image-text">
                            ...
                            <img src="images/testimonial/3.jpg" className="img-fluid" alt=""/>
                        </div>
                    </div>
            ...
            <div className="container">
                <div className="row">
                    <div className="col-lg-6 offset-lg-1">
                        <h2 className="s2">Call us for further information. Rentaly customer care is here to help you anytime.</h2>
                    </div>
